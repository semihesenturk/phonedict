...
public class GenericRepository<TEntity> : IGenericRepository<TEntity> where TEntity : BaseEntity
{
    ...
    #region Constructor
    public GenericRepository(DbContext contactContext)
    {
        this.dbContext = contactContext ?? throw new ArgumentNullException(nameof(contactContext));
    }
    #endregion
    ...
    public virtual Task BulkDelete(IEnumerable<TEntity> entites)
    {
        throw new NotImplementedException();
    }
    ...
    public virtual async Task BulkAdd(IEnumerable<TEntity> entites)
    {
